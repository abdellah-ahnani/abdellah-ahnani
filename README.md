...
|---------|-------------|-------|
| [RAG Engine](https://github.com/abdellah-ahnani/rag-engine) | Document QA system with FAISS vector store, two-stage retrieval, and source-cited generation. Faithfulness 0.87, MRR 0.87. | Python, FastAPI, FAISS, Docker |
| [RepoLint](https://github.com/abdellah-ahnani/repolint) | Static analysis CLI that audits Python codebases: docstring coverage, dead code, import cycles. Processes 500 files in <10s. | Python, ast, networkx, Click |
